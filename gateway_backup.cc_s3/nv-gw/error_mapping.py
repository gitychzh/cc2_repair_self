#!/usr/bin/env python3
"""Error format conversion for NV proxy (nv_gw) — OpenAI format.

unify-nv: single-model dsv4p_nv, no fallback chain. _nv suffix (通用, 非 Hermes 专属).
Handles single-tier 5-key exhaustion failures with error messages.
"""
import json
