...
## 当前轮基线 (2026-08-02 12:25 CST, R-nvonly-post215 NOP 巡检轮)
- 主仓 git HEAD: 7fb8858 (post215); 本仓 master: 本轮 post215.
  (注: 本仓 STATE.md 走 master, 主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post215 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 39req (36×200/2×429/1×502, SR=92.3%, all_tiers_exhausted ×3, 配额限流).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post215 (115 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 36 | 2 | 1 | 92.3% (39req) |

hermes→dsv4p_nv SR=92.3% (39req): 36×200 + 2×429 + 1×502, all_tiers_exhausted ×3 (NVCF 配额限流, 5key 全 cooling).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
## 参数快照 (2026-08-02 12:25 CST, 无变化, 同 post214)
