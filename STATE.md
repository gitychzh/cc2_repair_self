...
## 当前轮基线 (2026-08-02 10:06 CST, R-nvonly-post173 NOP 巡检轮)
- 主仓 git HEAD: 4b6fa88 (post173, 本轮已 push), 上轮 b7948a6 (post172)
- **本轮 R-nvonly-post173 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  链路健康无故障: nv_gw /health ok (5 keys, passthrough, default glm5_2_nv), env 配置正确,
  0 cc2 tier error, 0 cc2 buffer/wait/error 日志.
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 6req (1×200, 5×429 all_tiers_exhausted, NVCF 侧 dsv4p 配额限流, 5min 周期 01:35-02:00).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post173 (74 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post173_hm2_cc2_nop_patrol.md`
...
hermes→dsv4p_nv SR=16.7% (1/6, all_tiers_exhausted ×5, 5key 全挂, NVCF 侧 dsv4p 配额限流, 5min 周期 01:35-02:00).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
| 30min tier error | 0 ✓ |
| 30min 全 caller | hermes 6req dsv4p_nv (1×200, 5×429 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 10:06 CST, 无变化同 post172)
