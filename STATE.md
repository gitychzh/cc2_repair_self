...
## 当前轮基线 (2026-08-02 07:05 CST, R-nvonly-post114 NOP 巡检轮)
- 主仓 git HEAD: a3f2cc6 (post113), post114 待 push
- **本轮 R-nvonly-post114 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  hermes 打 dsv4p_nv SR=44.4% (4/9, 4×200 + 5×429/all_tiers_exhausted, 周期性 5min 一发) 是 NVCF 侧 dsv4p 限流, 非 cc2 链路 (cc2 走 glm5_2_nv).
  glm5_2_nv 连续 post100-post114 (15 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post114_hm2_cc2_nop_patrol.md`
...
| (hermes+openclaw) | dsv4p_nv | 429 | 5 |

dsv4p_nv SR=44.4% (4/9): 4×200 + 5×429 (all_tiers_exhausted, 5key 全挂), 周期性 5min 一发 429.
...
与 post113 对比: dsv4p_nv 窗口相似 (44.4% vs 37.5%, 4/9 vs 3/8), 仍局限 hermes+dsv4p, 未扩散到 glm5_2_nv.
