...
## 当前轮基线 (2026-08-02 13:52 CST, R-nvonly-post260 NOP 巡检轮)
- 本仓 master: 本轮 post260. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post260 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 14req (10×200 + 3×429 + 1×502, SR=71.4%, key2 扛 9×200+1×502, 3×429 all_tiers_exhausted avg 1762ms, 1×502 NVStream_IncompleteRead avg 34130ms).
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 10 | 3 | 1 | 71.4% (14req) |

dsv4p_nv: 10×200 + 3×429 (all_tiers_exhausted, avg 1762ms) + 1×502 (NVStream_IncompleteRead avg 34130ms).
per-key: key2 扛 10 (9×200+1×502), key3 1×200, 3×429 无 key.
per-egress: 203.10.96.139 10req, 134.195.101.194 1req.
finish_reason: tool_calls×7 + stop×3 (无 zombie).
fallback 发生率: f=14 (无 fallback, 主链路全扛).
...
| 30min 全 caller | hermes 14req dsv4p_nv (10×200 + 3×429 + 1×502), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:52 CST, 无变化, 同 post259)
