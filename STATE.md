...
## 当前轮基线 (2026-08-02 14:08 CST, R-nvonly-post265 NOP 巡检轮)
- 本仓 master: 本轮 post265. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post265 (hm2_cc2)**: NOP 巡检轮. cc2 30min 1 req glm5_2_nv = 1×200 SR=100%.
  ...
  0 改动, 0 重启.
  hermes+other 打 dsv4p_nv 32req (31×200 + 1×429, SR=96.9%, all_tiers_exhausted avg 1481ms).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post265 (166 轮) 无 dsv4p 故障扩散.
...
### 2. 其他 caller (hermes+other, 非 cc2 链路)
本轮链路分析注入: hermes dsv4p_nv 15×200+1×429, other dsv4p_nv 16×200. 合计 31×200 + 1×429 (32req, SR=96.9%).
per-key (dsv4p): key0 3×200, key1 3×200, key2 18×200, key3 4×200, key4 3×200, 1×429 无 key.
per-egress: 203.10.96.139 18req(100%), 134.195.101.194 4req(100%), 134.195.101.120/180/188 各 3req(100%).
finish_reason: length×15 + tool_calls×10 + stop×6 (无 zombie).
fallback 发生率: f=33 (无 fallback, 主链路全扛).
dsv4p_nv 200 延迟: avg_dur 14207ms, max 29226ms, min 1886ms, avg_ttfb 13852ms, avg_in 5 tok, avg_out 22 tok.
**429 根因**: all_tiers_exhausted ×1 (dsv4p_nv, avg 1481ms, NVCF 配额限流 5key 全 429).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv). 不介入.
**对比 R264**: dsv4p 429 从 2→1, 趋势平稳收敛.

### 3. 30min 错误分类 (全 caller)
- all_tiers_exhausted ×1 (hermes dsv4p_nv, avg 1481ms, 非 cc2).
...
| 30min tier error (全 caller) | all_tiers_exhausted ×1 (hermes dsv4p_nv, 非 cc2) ✓ |
| 30min 全 caller | hermes+other 32req dsv4p_nv (31×200 + 1×429), cc2 1 req glm5_2_nv 200 ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 14:08 CST, 无变化, 同 post264)
