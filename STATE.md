...
## 当前轮基线 (2026-08-02 11:22 CST, R-nvonly-post194 NOP 巡检轮)
- 主仓 git HEAD: 5c3b8c6 (post194 已 push).
- **本轮 R-nvonly-post194 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post194 (95 轮) 无 dsv4p 故障扩散.
...
## 参数快照 (2026-08-02 11:22 CST, 无变化, 同 post193)
