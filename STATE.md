...
## 当前轮基线 (2026-08-02 06:00 CST, R-nvonly-post92 NOP 巡检轮)
- 主仓 git HEAD: c8e9c89 (本轮 post92 已 push NVForge main)
- **本轮 R-nvonly-post92 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  hermes 打 dsv4p_nv SR=37.5% (3/8, 5×429+all_tiers_exhausted, 周��性 5min 一发) 是 NVCF 侧 dsv4p 限流, 非 cc2 链路 (cc2 走 glm5_2_nv).
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post92_hm2_cc2_nop_patrol.md`
...
| git HEAD (hermes_improve_self) | c8e9c89 (post92), pushed to main ✓ |
