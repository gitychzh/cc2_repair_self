...
## 当前轮基线 (2026-08-02 12:36 CST, R-nvonly-post221 NOP 巡检轮)
- 主仓 git HEAD: f65590a (post219); 本仓 master: 本轮 post221.
  (注: 本仓 STATE.md 走 master, 主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post221 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 27req (23×200/4×429, SR=85.2%, all_tiers_exhausted ×4, 配额限流).
...
| 30min 全 caller | hermes 27req dsv4p_nv (23×200/4×429 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 12:36 CST, 无变化, 同 post219)
