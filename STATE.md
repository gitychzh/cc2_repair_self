...
## 当前轮基线 (2026-08-02 13:34 CST, R-nvonly-post255 NOP 巡检轮)
- 本仓 master: 本轮 post255. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post255 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  链路健康无故障: nv_gw /health ok (passthrough, 5 keys, default glm5_2_nv), env 配置正确,
  全容器 Up 12h+, 0 cc2 tier error (nv_tier_attempts 30min 空), 0 cc2 buffer/wait/error 日志.
  0 改动, 0 重启.
  hermes/openclaw 打 dsv4p_nv 22req (18×200 + 3×429 + 1×502, SR=81.8%, key2 扛 17×200+1×502, key3 1×200, 3×429 all_tiers_exhausted, 1×502 NVStream_IncompleteRead avg 34130ms).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post255 (156 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 17 | 3 | 1 | 77.3% (21req) |
| openclaw | dsv4p_nv | 1 | 0 | 0 | 100% (1req) |

dsv4p_nv SR=81.8% (22/22): 18×200 + 3×429 (all_tiers_exhausted, avg 2855ms) + 1×502 (NVStream_IncompleteRead avg 34130ms).
per-key: key2 扛 17×200 (avg 10436ms) + 1×502, key3 1×200 (4219ms), 3×429 无 key.
per-egress: 203.10.96.139 18×200 (94ms), 134.195.101.194 1×200.
finish_reason: tool_calls×15, stop×3 (无 zombie).
fallback 发生率: 0/22 (无 fallback, 主链路全扛).
按分钟趋势: 05:00-05:11 稳定 200, 05:15/05:20/05:25 各 1×429, 05:31 1×502.
