...
## 当前轮基线 (2026-08-02 09:53 CST, R-nvonly-post171 NOP 巡检轮)
- 主仓 git HEAD: 37726cc (post170, 上轮), 本轮 post171 (待 commit)
- **本轮 R-nvonly-post171 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  链路健康无故障: nv_gw /health ok (5 keys, passthrough, default glm5_2_nv), env 配置正确,
  0 cc2 tier error, 0 cc2 buffer/wait/error 日志.
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 6×429 (all_tiers_exhausted, NVCF 侧 dsv4p 配额限流, 5min 周期 01:25-01:50).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post171 (72 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post171_hm2_cc2_nop_patrol.md`
...
|--------|-------|--------|-------|---------|
| hermes | dsv4p_nv | 429 | 6 | 1751 |

hermes→dsv4p_nv 6×429 (all_tiers_exhausted, 5key 全挂, NVCF 侧 dsv4p 配额限流, 5min 周期 01:25-01:50).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).

### 3. 30min 错误分类
| error_type | sub | count | avg_dur |
|------------|-----|-------|---------|
| all_tiers_exhausted | all_tiers_failed_in_mapped_tier | 6 | 1751 |
...
## 参数快照 (2026-08-02 09:53 CST, 无变化同 post170)
