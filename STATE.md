...
## 当前轮基线 (2026-08-02 13:40 CST, R-nvonly-post257 NOP 巡检轮)
- 本仓 master: 本轮 post257. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post257 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 14req (8×200 + 5×429 + 1×502, SR=57.1%, key2 扛 8×200+1×502, 5×429 all_tiers_exhausted avg 2455ms, 1×502 NVStream_IncompleteRead avg 34130ms).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post257 (158 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 8 | 5 | 1 | 57.1% (14req) |

dsv4p_nv SR=57.1% (14/14): 8×200 + 5×429 (all_tiers_exhausted, avg 2455ms) + 1×502 (NVStream_IncompleteRead avg 34130ms).
per-key: key2 扛 8×200 (avg 10106ms) + 1×502, 5×429 无 key.
...
按分钟趋势: 05:10-05:11 稳定 200, 05:15 1×429, 05:20 1×429, 05:25 1×429, 05:30 3×200, 05:31 1×502, 05:35 1×429, 05:40 1×429.
...
- all_tiers_exhausted ×5 (hermes dsv4p_nv, avg 2455ms, 非 cc2).
...
| 30min tier error (全 caller) | all_tiers_exhausted ×5 + NVStream_IncompleteRead ×1 (hermes dsv4p_nv, 非 cc2) ✓ |
| 30min 全 caller | hermes 14req dsv4p_nv (8×200 + 5×429 + 1×502), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:40 CST, 无变化, 同 post256)
