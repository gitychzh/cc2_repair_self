...
## 当前轮基线 (2026-08-02 18:20 CST, R321 NOP 巡检轮)
- 本仓 master: 上轮 R320 (a5269ca) 已 push. 主仓 hm2 侧 R320 (a5269ca) 已 push.
- **架构 (主仓 a5269ca)**: cc4101 `PRIMARY_UPSTREAM_MODEL=dsv4p_nv`.
  cc2 链路 = cc4101(dsv4p_nv) → nv_gw → NVCF.
- **本轮 R321 (hm2_cc2)**: NOP 巡检轮. cc2 (cc4101-primary) 30min 0 req (session 间歇空闲).
  dsv4p_nv 30min 全 caller SR=92.9% (26/28), 失败 2 = 1× all_tiers_exhausted
...
## 根因: buffer 对 function 级 429 无保护 (设计盲区, 非代码缺陷, 沿用 R278-R321 分析)
...
- buffer 5key 轮转对 key/IP 级 429 仍有效 (R268-R321 验证), 对 function 级 429 是已知盲区.
