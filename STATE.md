...
## 当前轮基线 (2026-08-02 09:15 CST, R-nvonly-post150 NOP 巡检轮)
- 主仓 git HEAD: d2ee638 (post149), post150 round 文件待 push
- **本轮 R-nvonly-post150 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  glm5_2_nv ��续 post100-post150 (51 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post150_hm2_cc2_nop_patrol.md`
...
dsv4p_nv SR=0.0% (0/6): 6×429 (all_tiers_exhausted, 5key 全挂, avg_dur=1669s).
周期性 5min 一发 429 (00:20/25/30/35/40/45), NVCF 侧 dsv4p 限流模式, 非 cc2 链路问题.
...
- glm5_2_nv 链路连续 51 轮稳定 (post100-post150), 无需调整.
