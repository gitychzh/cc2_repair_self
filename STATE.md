...
## 当前轮基线 (2026-08-02 12:20 CST, R-nvonly-post213 NOP 巡检轮)
- 主仓 git HEAD: 067d93b (post211); 本仓 master: 本轮 post213.
  (注: 本仓 STATE.md 走 master, 主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post213 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 34req (32×200/1×429/1×502, SR=94.1%, all_tiers_exhausted × 2, 配额限流).
...
| 30min 全 caller | hermes 34req dsv4p_nv (32×200/1×429/1×502 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 12:20 CST, 无变化, 同 post212)
