...
## 当前轮基线 (2026-08-02 06:57 CST, R-nvonly-post112 NOP 巡检轮)
- 主仓 git HEAD: a0e67bb (post112 已 push)
- **本轮 R-nvonly-post112 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  glm5_2_nv 连续 post100-post112 (13 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post112_hm2_cc2_nop_patrol.md`
...
与 post111 对比: dsv4p_nv 窗口相同 (37.5%, 3/8), 仍局限 hermes+dsv4p, 未扩散到 glm5_2_nv.
...
- dsv4p_nv 限流持续, 但属 NVCF 侧 + hermes caller, 非本轮��责 (只改 HM2 nv_gw, 不碰 caller).
- glm5_2_nv 链路连续 13 轮稳定, 无需调整.
