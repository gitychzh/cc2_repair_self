...
## 当前轮基线 (2026-08-02 13:30 CST, R-nvonly-post254 NOP 巡检轮)
- 本仓 master: 本轮 post254. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post254 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  链路健康无故障: nv_gw /health ok (passthrough, 5 keys, default glm5_2_nv), env 配置正确,
  全容器 Up 11h+, 0 cc2 tier error (nv_tier_attempts 30min 空), 0 cc2 buffer/wait/error 日志.
  0 改动, 0 重启.
  hermes/openclaw 打 dsv4p_nv 25req (22×200 + 3×429, SR=88%, key2 扛 21×200 + key3 1×200, 3×429 all_tiers_exhausted).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post254 (155 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|
| hermes | dsv4p_nv | 21 | 3 | 87.5% (24req) |
| openclaw | dsv4p_nv | 1 | 0 | 100% (1req) |

dsv4p_nv SR=88.0% (25/25): 22×200 + 3×429 (all_tiers_exhausted, avg 2855ms).
per-key: key2 扛 21×200 (avg 10515ms), key3 1×200 (4219ms), 3×429 无 key.
per-egress: 203.10.96.139 21×200 (100% SR), 134.195.101.194 1×200.
finish_reason: tool_calls×18, stop×4 (无 zombie).
fallback 发生率: 0/25 (无 fallback, 主链路全扛).
按分钟趋势: 05:00-05:11 稳定 200, 05:15/05:20/05:25 各 1×429.
**429 根因**: NV-ALL-TIERS-FAIL, ring tiers tried=['dsv4p_nv'], ABORT-NO-FALLBACK.
...
| 30min tier error (全 caller) | all_tiers_exhausted ×3 (hermes dsv4p_nv, 非 cc2) ✓ |
| 30min 全 caller | hermes 24req + openclaw 1req dsv4p_nv (22×200 + 3×429), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:30 CST, 无变化, 同 post253)
