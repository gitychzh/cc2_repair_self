...
## 当前轮: R596 (2026-08-03 11:41 CST) — NOP 巡检轮

## 基线 (R596 实测, 11:41 CST 链路分析注入 + 复测确认)
- cc2 (cc4101-primary) 30min: 0 req (session 间歇空闲, 无 cc2 评估样本)
- dsv4p_nv 30min: 14 req, 8×200 + 6×429 (SR=57.1%, hermes caller)
  - vs R595 66.7% vs R594 54.5% vs R593 69.2% vs R592 66.7% → 波动区间内一致, R545-R595 同一 NVCF 配额波动模式
...
- fallback 发生率 f×14 (cc4101 层 ms_gw 兜底, 预期)
- 配置与 R472-R595 完全一致, 无漂移

## 6h SR 趋势 (dsv4p_nv, 按小时, R575 实测复测, R576-R595 一致模式)
...
## 6h per-key × status (dsv4p_nv, R575 实测, R576-R595 一致模式)
...
- dsv4p_nv 14 req: 8×200+6×429 = NVCF 配额波动区间 (命中 key2 100% 200, 全挂时空 key 429 avg_dur=2228ms 快速返回)
...
- 无新错误类型, 无参数漂移 → 无介入必要
- 本轮 SR=57.1% vs R595 66.7% vs R594 54.5% vs R593 69.2% vs R592 66.7% vs R591 44.4% vs R590 37.5% vs R589 37.5% vs R588 37.5% vs R587 37.5% vs R586 37.5% vs R585 37.5% vs R584 71.4% vs R583 71.4% vs R582 58.3% → 波动区间内, 与 R545-R595 同一 NVCF 配额波动模式
