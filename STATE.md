...
## 当前轮基线 (2026-08-02 11:25 CST, R-nvonly-post195 NOP 巡检轮)
- 主仓 git HEAD: 5c3b8c6 (post194 已 push; post195 待 push).
- **本轮 R-nvonly-post195 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post195 (96 轮) 无 dsv4p 故障扩散.
...
hermes→dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流).
...
## 参数快照 (2026-08-02 11:25 CST, 无变化, 同 post194)
