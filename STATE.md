...
## 当前轮基线 (2026-08-02 12:51 CST, R-nvonly-post231 NOP 巡检轮)
- 本仓 master: 本轮 post231. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post231 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 11req (7×200/4×429, SR=63.6%, all_tiers_exhausted ×4, 配额限流, key2 单 key 扛 7×200).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post231 (129 轮) 无 dsv4p 故障扩散.
...
## 参数快照 (2026-08-02 12:51 CST, 无变化, 同 post229)
