...
- **本轮 R-nvonly-post247 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes/openclaw 打 dsv4p_nv 30req (30×200, SR=100%, 无限流, key2 扛 29×200 + key3 1×200).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post247 (144 轮) 无 dsv4p 故障扩散.
...
| caller | model | 200 | SR |
|--------|--------|-----|-----|
| hermes | dsv4p_nv | 29 | 100% (29req) |
| openclaw | dsv4p_nv | 1 | 100% (1req) |

dsv4p_nv SR=100% (30/30): 全 200, 无 429 无限流 (上轮 post245 有 1×429, 本轮恢复).
per-key: key2 扛 29×200 (avg_dur 10358ms), key3 1×200 (avg_dur 4219ms).
per-egress: 203.10.96.139 29×200 (100% SR), 134.195.101.194 1×200.
finish_reason: tool_calls×23, stop×7 (无 zombie).
fallback 发生率: 0/30 (无 fallback, 主链路全扛).
按分钟趋势: 04:45-05:11 稳定 200, 无错误.
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
