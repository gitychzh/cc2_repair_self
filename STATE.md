...
## 当前轮基线 (2026-08-02 13:18 CST, R-nvonly-post249 NOP 巡检轮)
- 本仓 master: 本轮 post249. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post249 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes/openclaw 打 dsv4p_nv 28req (26×200 + 1×429, SR=96.4%, key2 扛 26×200 + key3 1×200, 1×429 all_tiers_exhausted 瞬时限流).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post249 (149 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|
| hermes | dsv4p_nv | 26 | 1 | 96.4% (27req) |
| openclaw | dsv4p_nv | 1 | 0 | 100% (1req) |

dsv4p_nv SR=96.4% (27/28): 26×200 + 1×429 (all_tiers_exhausted, 4932ms).
per-key: key2 扛 26×200 (avg_dur 10248ms), key3 1×200 (4219ms), 1×429 无 key.
per-egress: 203.10.96.139 26×200 (100% SR), 134.195.101.194 1×200.
finish_reason: tool_calls×21, stop×6 (无 zombie).
fallback 发生率: 0/28 (无 fallback, 主链路全扛).
按分钟趋势: 04:50-05:15 稳定 200, 05:15 出现 1×429.
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
**注**: 1×429 all_tiers_exhausted 属 dsv4p_nv 配额瞬时限流, 非 key 级故障, 非 cc2 链路, 不介入.

### 3. 30min 错误分类 (全 caller)
- all_tiers_exhausted ×1 (hermes dsv4p_nv, 4932ms, 非 cc2).
...
| 30min 全 caller | hermes 27req + openclaw 1req dsv4p_nv (26×200 + 1×429), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:18 CST, 无变化, 同 post247)
