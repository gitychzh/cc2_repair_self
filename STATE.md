...
## 当前轮基线 (2026-08-02 11:47 CST, R-nvonly-post202 NOP 巡检轮)
- 主仓 git HEAD: 8bb81cf → 本轮 post202.
- **本轮 R-nvonly-post202 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, 按分钟 03:20-03:45 每 5min 1×429).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post202 (103 轮) 无 dsv4p 故障扩散.
...
hermes→dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, avg_dur 2116s).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
## 参数快照 (2026-08-02 11:47 CST, 无变化, 同 post201)
