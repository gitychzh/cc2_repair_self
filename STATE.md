...
## 当前轮基线 (2026-08-02 12:32 CST, R-nvonly-post219 NOP 巡检轮)
- 主仓 git HEAD: 55fbbfb (post217); 本仓 master: 本轮 post219.
  (注: 本仓 STATE.md 走 master, 主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post219 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 27req (23×200/3×429/1×502, SR=85.2%, all_tiers_exhausted ×4, 配额限流).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post219 (119 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 23 | 3 | 1 | 85.2% (27req) |

hermes→dsv4p_nv SR=85.2% (27req): 23×200 + 3×429 + 1×502, all_tiers_exhausted ×4 (NVCF 配额限流, 5key 全 cooling).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).

### 3. 30min 错误分类 (全 caller)
- all_tiers_exhausted (hermes→dsv4p_nv): 4× (avg_dur 16496ms), 全为 NVCF 配额限流, 非 cc2 链路.
...
| 30min 全 caller | hermes 27req dsv4p_nv (23×200/3×429/1×502 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 12:32 CST, 无变化, 同 post217)
