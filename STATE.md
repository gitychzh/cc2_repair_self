...
## 当前轮: R603 (2026-08-03 12:20 CST) — NOP 巡检轮

## 基线 (R603 链路分析注入, 12:19 CST)
- cc2 (cc4101-primary) 30min: 0 req (session 间歇空闲, 无 cc2 评估样本)
- dsv4p_nv 30min: 26 req, 22×200 + 2×429 + 2×502 (SR=84.6%, hermes caller)
  - vs R602 84.6% vs R601 66.7% vs R600 61.5% vs R599 45.5% vs R598 50.0% → 波动区间, NVCF 配额型
...
- 配置与 R472-R602 完全一致, 无漂移

## 6h SR 趋势 (dsv4p_nv, 按小时, R575 实测复测, R576-R602 一致模式)
...
## 6h per-key × status (dsv4p_nv, R575 实测, R576-R602 一致模式)
...
- 无新错误类型, 无参数漂移 → 无介入必要
- 本轮 SR=84.6% vs R602 84.6% vs R601 66.7% vs R600 61.5% vs R599 45.5% vs R598 50.0% vs R597 50.0% vs R596 57.1% vs R595 66.7% vs R594 54.5% vs R593 69.2% vs R592 66.7% vs R591 44.4% vs R590 37.5% vs R589 37.5% → 波动区间内, 与 R545-R602 同一 NVCF 配额波动模式
