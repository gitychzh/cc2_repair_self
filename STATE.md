...
## 当前轮基线 (2026-08-02 12:05 CST, R-nvonly-post207 NOP 巡检轮)
- 主仓 git HEAD: 29597a9 (post205) → 本轮 post207.
  (注: post206 STATE.md 已提交于本仓 master 分支 ce57737, 主仓 main 分支 HEAD 仍停在 post205 29597a9, 因主仓只收 hermes_improve_self 侧改动, cc2 STATE 走本仓 master.)
- **本轮 R-nvonly-post207 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 19req (14×200/4×429/1×502, SR=73.7%, all_tiers_exhausted × 5, 配额限流).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post207 (107 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 14 | 4 | 1 | 73.7% (19req) |

hermes→dsv4p_nv SR=73.7% (19req): 14×200 + 4×429 + 1×502, all_tiers_exhausted × 5 (NVCF 配额限流, 5key 全 cooling).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
| 30min 全 caller | hermes 19req dsv4p_nv (14×200/4×429/1×502 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 12:05 CST, 无变化, 同 post206)
