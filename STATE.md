...
## 当前轮基线 (2026-08-02 09:00 CST, R-nvonly-post149 NOP 巡检轮)
- 主仓 git HEAD: dad6878 (post148), post149 round 文件待 push
- **本轮 R-nvonly-post149 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  glm5_2_nv 连续 post100-post149 (50 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post149_hm2_cc2_nop_patrol.md`
...
dsv4p_nv SR=0.0% (0/6): 6×429 (all_tiers_exhausted, 5key 全挂, avg_dur=1687s).
周期性 5min 一发 429 (00:15/20/25/30/35/40), NVCF 侧 dsv4p 限流模式, 非 cc2 链路问题.
...
- glm5_2_nv 链路连续 50 轮稳定 (post100-post149), 无需调整.
