...
## 当前轮基线 (2026-08-02 07:36 CST, R-nvonly-post125 NOP 巡检轮)
- 主仓 git HEAD: a0e113a post125 已 push origin main (上一轮 65d6e44 post124)
- **本轮 R-nvonly-post125 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes+openclaw 打 dsv4p_nv SR=37.5% (3/8, 3×200 + 5×429/all_tiers_exhausted, 周期性 5min 一发) 是 NVCF 侧 dsv4p 限流, 非 cc2 链路 (cc2 走 glm5_2_nv).
  glm5_2_nv 连续 post100-post125 (26 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post125_hm2_cc2_nop_patrol.md`
...
与 post124 对比: dsv4p_nv 窗口略降 (37.5% vs 44.4%), 仍局限 hermes+dsv4p, 未扩散到 glm5_2_nv.
...
| docker ps | nv_gw/cc4101 Up 6h, nv_gw_stable Up 6h, ms_gw/logs_db Up 2d ✓ |
