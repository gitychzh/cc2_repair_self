...
## 当前轮基线 (2026-08-02 07:10 CST, R-nvonly-post115 NOP 巡检轮)
- 主仓 git HEAD: c4b0cc6 (post114), post115 待 push
- **本轮 R-nvonly-post115 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  glm5_2_nv 连续 post100-post115 (16 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post115_hm2_cc2_nop_patrol.md`
...
与 post114 对比: dsv4p_nv 窗口相同 (44.4%, 4/9), 仍局限 hermes+dsv4p, 未扩散到 glm5_2_nv.
