...
- 配置与 R472-R589 完全一致, 无漂移

## 6h SR 趋势 (dsv4p_nv, 按小时, R575 实测复测, R576-R589 一致模式)
...
## 6h per-key × status (dsv4p_nv, R575 实测, R576-R589 一致模式)
...
- 无新错误类型, 无参数漂移 → 无介入必要
- 本轮 SR=37.5% vs R589 37.5% vs R588 37.5% vs R587 37.5% vs R586 37.5% vs R585 37.5% vs R584 71.4% vs R583 71.4% vs R582 58.3% → 波动区间内, 与 R545-R589 同一 NVCF 配额波动模式
