...
## 当前轮基线 (2026-08-02 13:55 CST, R-nvonly-post261 NOP 巡检轮)
- 本仓 master: 本轮 post261. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post261 (hm2_cc2)**: NOP 巡检轮. cc2 30min 1 req glm5_2_nv = 1×200 SR=100%.
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 24req (20×200 + 3×429 + 1×502, SR=83.3%, key2 扛 11×200+1×502, 3×429 all_tiers_exhausted avg 1762ms, 1×502 NVStream_IncompleteRead avg 34130ms).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post261 (162 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 20 | 3 | 1 | 83.3% (24req) |

dsv4p_nv: 20×200 + 3×429 (all_tiers_exhausted, avg 1762ms) + 1×502 (NVStream_IncompleteRead avg 34130ms).
per-key: key2 扛 12 (11×200+1×502), key0/key1 各 2×200, key3 3×200, key4 2×200, 3×429 无 key.
...
| 30min 全 caller | hermes 24req dsv4p_nv (20×200 + 3×429 + 1×502), cc2 1 req glm5_2_nv 200 ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:55 CST, 无变化, 同 post260)
...
## 下一步
继续 NOP 巡检. 等 cc2 流��增多后再判 SR 细节. 若 dsv4p_nv 配额限流持续扩散到 glm5_2_nv 再介入.
