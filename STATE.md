...
## 当前轮基线 (2026-08-02 07:10 CST, R-nvonly-post116 NOP 巡检轮)
- 主仓 git HEAD: f6d7cab (post115), post116 待 push
- **本轮 R-nvonly-post116 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  hermes+openclaw 打 dsv4p_nv SR=33.3% (3/9, 3×200 + 6×429/all_tiers_exhausted, 周期性 5min 一发) 是 NVCF 侧 dsv4p 限流, 非 cc2 链路 (cc2 走 glm5_2_nv).
  glm5_2_nv 连续 post100-post116 (17 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post116_hm2_cc2_nop_patrol.md`
...
| (hermes+openclaw) | dsv4p_nv | 429 | 6 |

dsv4p_nv SR=33.3% (3/9): 3×200 + 6×429 (all_tiers_exhausted, 5key 全挂, avg_dur 1225s), 周期性 5min 一发 429.
...
周期性 5min 一发 429, 22:40 恢复 200×2, NVCF 侧 dsv4p 限流模式, 非 cc2 链路问题.
与 post115 对比: dsv4p_nv 窗口略降 (33.3% vs 44.4%), 仍局限 hermes+dsv4p, 未扩散到 glm5_2_nv.
