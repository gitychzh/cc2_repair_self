...
## 当前轮基线 (2026-08-02 12:05 CST, R-nvonly-post208 NOP 巡检轮)
- 主仓 git HEAD: 29597a9 (post205); 本仓 master: ce57737(post206)→73c4e33(post207)→本轮 post208.
  (注: post206/post207 STATE.md 已提交于本仓 master, 主仓 main 分支 HEAD 仍停在 post205 29597a9, 主仓只收 hermes_improve_self 侧改动, cc2 STATE 走本仓 master.)
- **本轮 R-nvonly-post208 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 19req (14×200/3×429/1×502, SR=77.8%, all_tiers_exhausted × 4, 配额限流).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post208 (108 轮) 无 dsv4p 故障扩散.
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 14 | 3 | 1 | 77.8% (19req) |

hermes→dsv4p_nv SR=77.8% (19req): 14×200 + 3×429 + 1×502, all_tiers_exhausted × 4 (NVCF 配额限流, 5key 全 cooling).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).

### 3. 30min 错误分类 (全 caller)
- all_tiers_exhausted (hermes→dsv4p_nv): 4× (avg_dur 15162ms), 全为 NVCF 配额限流, 非 cc2 链路.
...
| 30min 全 caller | hermes 19req dsv4p_nv (14×200/3×429/1×502 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 12:05 CST, 无变化, 同 post207)
