...
## 当前轮基线 (2026-08-02 08:25 CST, R-nvonly-post142 NOP 巡检轮)
- 主仓 git HEAD: 待 push (post142 round 文件已建)
- **本轮 R-nvonly-post142 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv SR=40.0% (4/10, 6×429 all_tiers_exhausted 周期性 5min 一发 + 4×200) 是 NVCF 侧 dsv4p 限流, 非 cc2 链路 (cc2 走 glm5_2_nv).
  glm5_2_nv 连续 post100-post142 (43 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post142_hm2_cc2_nop_patrol.md`
...
dsv4p_nv SR=40.0% (4/10): 6×429 (all_tiers_exhausted, 5key 全挂, avg_dur=1554s) + 4×200 (avg_dur=15659ms).
