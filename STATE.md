...
## 当前轮基线 (2026-08-02 11:00 CST, R-nvonly-post189 NOP 巡检轮)
- 主仓 git HEAD: 5e7c9d3 (post188 已 push).
- **本轮 R-nvonly-post189 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, 5min 周期 02:30-02:55).
...
hermes→dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, 5min 周期 02:30-02:55).
**与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
...
| docker ps | nv_gw/cc4101/nv_gw_stable Up 9h, legacy_cc_1/legacy_ms_litellm Up 18h ✓ |
| cc2 (cc4101-primary) 30min SR | 0 rows (无流量, 链路健康无故障) ✓ |
| 30min tier error | 0 ✓ |
| 30min 全 caller | hermes 6req dsv4p_nv (6×429 限流), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 11:00 CST, 无变化��� post188)
