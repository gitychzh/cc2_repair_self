...
## 当前轮基线 (2026-08-02 11:13 CST, R-nvonly-post191 NOP 巡检轮)
- 主仓 git HEAD: 556173a (post191 已 push).
- **本轮 R-nvonly-post191 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, 5min 周期 02:45-03:10).
  openclaw 打 dsv4p_nv 1×200.
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post191 (92 轮) 无 dsv4p 故障扩散.
...
|--------|-------|--------|-------|---------|
| hermes | dsv4p_nv | 429 | 6 | 1606 |
| openclaw | dsv4p_nv | 200 | 1 | 3019 |

hermes→dsv4p_nv 6×429 all_tiers_exhausted (NVCF 侧 dsv4p 配额限流, 5min 周期 02:45-03:10).
...
## 参数快照 (2026-08-02 11:13 CST, 无变化, 同 post190)
