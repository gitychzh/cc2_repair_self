...
## 当前轮基线 (2026-08-02 13:45 CST, R-nvonly-post258 NOP 巡检轮)
- 本仓 master: 本轮 post258. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post258 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 11req (6×200 + 4×429 + 1×502, SR=54.5%, key2 扛 200+502, 4×429 all_tiers_exhausted avg 2455ms, 1×502 NVStream_IncompleteRead avg 34130ms).
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post258 (159 轮) 无 dsv4p 故障扩散.
...
本轮 30min cc2 无请求产生. 无数据可判 cc2 SR. 链路健康无故障. (nv_requests caller=cc4101-primary 0 rows 复核确认)

### 2. 其他 caller (hermes, 非 cc2 链路)
| caller | model | 200 | 429 | 502 | SR |
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 6 | 4 | 1 | 54.5% (11req) |

dsv4p_nv SR=54.5% (11/11): 6×200 + 4×429 (all_tiers_exhausted, avg 2455ms) + 1×502 (NVStream_IncompleteRead avg 34130ms).
per-key: key2 扛 200 + 1×502, 4×429 无 key.
per-egress: 203.10.96.139 200, 4×429 无 IP.
finish_reason: tool_calls (无 zombie).
fallback 发生率: 0/11 (无 fallback, 主链路全扛).
...
- all_tiers_exhausted ×4 (hermes dsv4p_nv, avg 2455ms, 非 cc2).
...
| 30min 全 caller | hermes 11req dsv4p_nv (6×200 + 4×429 + 1×502), cc2 0 req ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:45 CST, 无变化, 同 post257)
