...
## 当前轮基线 (2026-08-02 13:58 CST, R-nvonly-post262 NOP 巡检轮)
- 本仓 master: 本轮 post262. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post262 (hm2_cc2)**: NOP 巡检轮. cc2 30min 1 req glm5_2_nv = 1×200 SR=100%.
  ...
  0 改动, 0 重启.
  hermes 打 dsv4p_nv 31req (28×200 + 2×429 + 1×502, SR=90.3%, key2 扛 15×200+1×502, 2×429 all_tiers_exhausted avg 1855ms, 1×502 NVStream_IncompleteRead avg 34130ms).
...
|--------|--------|-----|-----|-----|-----|
| hermes | dsv4p_nv | 28 | 2 | 1 | 90.3% (31req) |
| other  | dsv4p_nv | 16  | 0   | 0   | 100%  (16req) |

dsv4p_nv: 28×200 + 2×429 (all_tiers_exhausted, avg 1855ms) + 1×502 (NVStream_IncompleteRead avg 34130ms).
per-key: key2 扛 16 (15×200+1×502), key0/key1 各 3×200, key3 4×200, key4 3×200, 2×429 无 key.
...
| 30min 全 caller | hermes+other 31req dsv4p_nv (28×200 + 2×429 + 1×502), cc2 1 req glm5_2_nv 200 ✓ |
| 配置 | NVU_DISABLE_MS_FALLBACK=0 (fallback 已恢复), FALLBACK_UPSTREAM=ms_gw:40007 ✓ |

## 参数快照 (2026-08-02 13:58 CST, 无变化, 同 post261)
