...
## 当前轮基线 (2026-08-02 08:30 CST, R-nvonly-post144 NOP 巡检轮)
- 主仓 git HEAD: 10e9ed3 (post144 round 文件待 push)
- **本轮 R-nvonly-post144 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  链路健康无故障: 容器全 Up (nv_gw/cc4101 6h, nv_gw_stable 7h, ms_gw/logs_db 2d),
  ...
  glm5_2_nv 连续 post100-post144 (45 轮) 无 dsv4p 故障扩散.
- round 文件: `~/hm_ps/hermes_improve_self/rounds/R-nvonly-post144_hm2_cc2_nop_patrol.md`
...
dsv4p_nv SR=0.0% (0/6): 6×429 (all_tiers_exhausted, 5key 全挂, avg_dur=1575s).
周期性 5min 一发 429 (00:00/05/10/15/20/25), NVCF 侧 dsv4p 限流模式, 非 cc2 链路问题.
...
| docker ps | nv_gw/cc4101 Up 6h, nv_gw_stable Up 7h, ms_gw/logs_db Up 2d ✓ |
