# R637 — NOP 巡检轮 (2026-08-03 14:30 CST)

## 基线 (R637 实测, 06:00-06:30 UTC 窗口)
- cc2 (cc4101-primary) 30min: 0 req (session 间歇空闲, 无 cc2 评估样本, 同 R626-R636)
- dsv4p_nv 30min (hermes caller): 8 req, 3×200 + 5×429 (SR=37.5%)
  - vs R636 37.5% / R635 37.5% / R634 37.5% / R633 64.7% / R632 73.7% / R631 76.2% / R630 80.8% / R629 86.7% / R628 90.3%
    → **本轮持平 R634/R635/R636 连续 3 轮, 仍在 R617-R636 正常波动区间下沿 (37-91%), 小样本 8req 波动剧烈, 趋势未恶化**
  - per-key: k2=3×200 全 first-attempt 命中, 空 key=5×429
  - per-egress-IP: 203.10.96.139 (单 IP 主力, 同 R630-R636)
  - finish_reason: tool_calls×2 + stop×1 (健康, 无 zombie)
  - 200 avg_dur=9634ms (持平 R634/R635/R636)
- 错误分类 1 类 (非新错误): `all_tiers_exhausted` ×5 (avg_dur 1733ms, 429 快速 ABORT)
  - R624-R637: 3→...→6→5→5→5→5, 持平 R634/R635/R636 仍在正常区间 3-6
...
- 23:00 37.5% → 00:00 42.1% → 01:00 29.4% → 02:00 59.1% → 03:00 56.5% → 04:00 86.8% → 05:00 76.3% → 06:00 37.5%
...
## 依据
- cc2 0 流量 → 铁律1 cc2 视角不满足 (同 R626-R636)
- dsv4p_nv SR=37.5% 持平 R634/R635/R636 连续 3 轮, 仍在正常波动区间下沿, 趋势未恶化
- 6h SR 29-87% 波动, 04:00 回升 86.8% → 配额型故障模式确认
- all_tiers_exhausted ×5 持平 R634/R635/R636, 仍在正常区间 3-6, 无退化
...
- 容器: nv_gw Up 24h (/health ok, 5 keys, nv_default_model=glm5_2_nv),
  cc4101 Up 14h, nv_gw_stable Up 36h, ms_gw Up 4d, logs_db Up 4d
- 配置无漂移 (env 全项匹配 R636 快照)
- stream_total_deadline 6h=0 (deadline 链铁证)
- KeyManager 日志铁证: 14:20/14:25 429 count decay + 指数退避正确

## 下一步
- dsv4p_nv SR 持平 R634/R635/R636 (37.5%), 仍在正常波动区间下沿, 无恶化
