...
## 当前轮基线 (2026-08-02 13:21 CST, R-nvonly-post251 NOP 巡检轮)
- 本仓 master: 本轮 post251. (主仓 hermes_improve_self main 收 round 文件.)
- **本轮 R-nvonly-post251 (hm2_cc2)**: NOP 巡检轮. cc2 30min 0 req (session 轮前无流量产生, 无数据可判 SR).
  ...
  **与 cc2 无关** (cc2 走 glm5_2_nv, 不打 dsv4p_nv).
  glm5_2_nv 连续 post100-post251 (151 轮) 无 dsv4p 故障扩散.
...
**429 根因 (nv_gw 日志 13:20:29)**: k3/k4/k5 同时 429 → tier 全挂 → TIER_COOLDOWN 180s → ALL-TIERS-FAIL ABORT-NO-FALLBACK.
...
## 参数快照 (2026-08-02 13:21 CST, 无变化, 同 post249)
